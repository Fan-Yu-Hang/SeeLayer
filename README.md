# SeeLayer
Feb8, take 4 bloody hours to seperate database's original table into 2 new tables, just for multi-images upload, and combine 4 elements( image, 3 bottons). I don't think we need to add TTS now, as an update surprise in next 3 months.
